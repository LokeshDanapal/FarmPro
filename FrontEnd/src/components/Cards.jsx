...
const Cards = (props) => {
  return (
    ...
    <Link
      className="border-none shadow-2xl rounded-none "
      to={"/singlefeed"}
      ...
      <div className="  gap-x-44  rounded-2xl hover:scale-y-105 hover:scale-x-105 ease-in-out border-2 border-gray-300 flex  flex-col my-3   max-w-full min-w-0 h-full mt-3 col-span-1 pb-3 bg-zinc-50">
        ...
        <div className="pt-6 pb-4 ">
          <img
            ...
            className="border-2 hover:animate-pulse p-1 mx-auto my-1 h-56 w-72 border-zinc-400 rounded-lg"
            alt="crop"
          />
        </div>
        ...
        <div className="h-32 border-y border-slate-200 overflow-auto my-6">
